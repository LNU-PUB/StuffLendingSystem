...
public class ItemTest {
  ...
  public void testItemImmutabilityWithAdditionalChecks() {
    ...
    Contract contract = new Contract("contractId", owner, owner, new Item("item2Id", owner, "Another Item",
        ItemCategory.TOOL, "Another Description", 15.0, 300, null), 400, 500);
    ...
    // there's no need to check for modifications to fetchedOwner affecting item's
    // owner.
    ...
    // Verify fetchedContract modifications do not affect the original item's
    // contract
    // This step is conceptual because Contract class fields are final; direct
    // modification isn't possible without setters.

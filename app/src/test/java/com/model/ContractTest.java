...
public class ContractTest {
    ...
    public void testContractCreation() {
        ...
        Contract contract = new Contract("contractId", owner, item, borrower, 400, 500);
    ...
    public void testCopyConstructor() {
        ...
        Member borrower = new Member("borrowerId", "Borrower", "borrower@example.com", "0987654321", 200);
        Item item = new Item("itemId", owner, "Item Name", ItemCategory.SPORT, "Description", 10.0, 300, null);
        Contract originalContract = new Contract("contractId", owner, item, borrower, 400, 500);
    ...
    public void testEquals() {
        ...
        Member borrower = new Member("borrowerId", "Borrower", "borrower@example.com", "0987654321", 200);
        Item item = new Item("itemId", owner, "Item Name", ItemCategory.SPORT, "Description", 10.0, 300, null);
        Contract contract1 = new Contract("contractId", owner, item, borrower, 400, 500);
        Contract contract2 = new Contract("contractId", owner, item, borrower, 400, 500);
        Contract contract3 = new Contract("anotherContractId", owner, item, borrower, 401, 501);
